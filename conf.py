...
BLOG_AUTHOR = "Cam MacRae"  # (translatable)
BLOG_TITLE = "Cam MacRae"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://cammacrae.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://cammacrae.github.io/"
BLOG_EMAIL = "cam.macrae+githubio@gmail.com"
BLOG_DESCRIPTION = "Incoherent ramblings..."  # (translatable)
...
property="cc:attributionName">Cameron MacRae</span> is licensed under a <a
rel="license" href="http://creativecommons.org/licenses/by-sa/4.0/">Creative
Commons Attribution-ShareAlike 4.0 International License</a>. <a rel="license" href="http://creativecommons.org/licenses/by-sa/4.0/"><img
...
CONTENT_FOOTER = 'Contents &copy; {date} <a href="mailto:{email}">Cameron MacRae</a>. Powered by <a href="https://getnikola.com" rel="nofollow">Nikola</a>.  {license}'
...
EXTRA_HEAD_DATA = """
    <!-- Google tag (gtag.js) -->
    <script async src="https://www.googletagmanager.com/gtag/js?id=G-01MM6W49G7"></script>
    <script>
      window.dataLayer = window.dataLayer || [];
      function gtag(){dataLayer.push(arguments);}
      gtag('js', new Date());

      gtag('config', 'G-01MM6W49G7');
    </script>"""
